...
const PoolDetail = () => {
  // need use client for the useParams hook to work
  const params = useParams();
  console.log("params", params);

  let isError = false;
  let pool: Promise<TPoolData> | undefined;

  useEffect(() => {
    const getPoolDetails = async () => {
      try {
        // having issue getting this to run...
        ...
        pool = Promise.resolve(response["microGrant"]);
      } catch (e) {
        isError = true;
        console.log(e);
      }
              ...
              <div className="flex items-center gap-x-6">
                ...
                <h1>
                  <div className="text-sm leading-6 text-gray-500">
                    {/* Pool <span className="text-gray-700">#{pool.poolId}</span> */}
                  </div>
